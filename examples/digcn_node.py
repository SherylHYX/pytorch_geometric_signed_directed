...
from torch_geometric_signed_directed.nn.directed import DiGCN_node_classification
...
model = DiGCN_node_classification(num_features=data.x.shape[1], hidden=16, label_dim=num_classes, dropout=0.5).to(device)
